...
{
	connect(IDInput, &QLineEdit::returnPressed,
			[this]() { passwordInput->setFocus(); });

	connect(passwordInput, &QLineEdit::returnPressed,
			this, &bva::LoginForm::onSubmitButtonClicked);
...
QString bva::LoginForm::getID() const
{
	return userID;
}

QString bva::LoginForm::getPassword() const
{
	return userPassword;
}
